...
![Ejemplo Rest con mascotas](assets/clase_3/ejemplo-rest-mascotas.png)

### Códigos de respuesta

Los códigos de estado HTTP indican si una petición HTTP específica se completó exitosamente.

![Códigos de estado HTTP informativos 1xx-5xx](assets/clase_3/codigos-informativos.png)
...
![Ejemplo real de embebido SOAP en REST](assets/clase_3/soap-embebido-rest-ejemplo.png)
...
![Diagrama del modelo OSI de 7 capas para comunicación en red](assets/clase_3/modelo-osi-capas.png)
