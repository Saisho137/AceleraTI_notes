...
1. [Bases de Datos Relacionales vs No Relacionales](#1-bases-de-datos-relacionales-vs-no-relacionales)
2. [Tipos de Bases de Datos NoSQL](#2-tipos-de-bases-de-datos-nosql)
3. [Escalamiento Vertical vs Horizontal](#3-escalamiento-vertical-vs-horizontal)
4. [Propiedad BASE](#4-propiedad-base)
5. [¿Cuándo usar SQL o NoSQL?](#5-cuándo-usar-sql-o-nosql)
6. [MongoDB](#6-mongodb)
7. [Ejercicio Práctico: Biblioteca](#7-ejercicio-práctico-biblioteca)
8. [Resumen](#8-resumen)
...
3. **Aprende primero Maven**, después Gradle (recomendación del profesor)
4. **Entiende el teorema CAP** para profundizar en consistencia vs disponibilidad
